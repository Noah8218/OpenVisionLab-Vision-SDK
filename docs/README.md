...
| Document | Role |
| --- | --- |
| [Current status and work contract](OPENVISIONLAB_CURRENT_STATUS.md) | PL-0009 exception/lifetime analyzer contract review, prior culture/API evidence, and blocked redistribution-clearance prerequisite |
