...
| Document | Role |
| --- | --- |
| [Current status and work contract](OPENVISIONLAB_CURRENT_STATUS.md) | PL-0007 invariant coordinate-text closure, PL-0006 diagnostics/lifetime/API-contract evidence, and blocked redistribution-clearance prerequisite |
